...
!function(t,e,i){function a(t){this.o={id:"gWidget",nodeSelector:"#gWidget, .gWidget",callbackName:"grastinPvzWidgetCallback",style:"width:100%; height:100%; display:block; border:0;",params:[],host:"//grastin.ru",protocol:"https:"==e.location.protocol?"https:":"http:"},this.el=null,this.iframeTemplate='<iframe id="gWidgetFrame" src="{host}/widget/gWidget.php{params}" style="{style}" scrolling="no" frameborder="0" allowtransparency="true" onload="onWidgetFrameLoad({id})"></iframe>',this.init()}a.prototype={init:function(){t.addEventListener?"loading"!==e.readyState?setTimeout(this.createWidgets.bind(this),0):t.addEventListener("DOMContentLoaded",this.createWidgets.bind(this),!1):t.attachEvent&&t.attachEvent("onload",this.createWidgets.bind(this)),t.onWidgetFrameLoad=this.onWidgetFrameLoad.bind(this)},createWidgets:function(){this.el=e.querySelectorAll(this.o.nodeSelector);for(var t=0,i=this.el.length;i>t;t+=1)!this.el[t].getAttribute("data-widget-ready")&&this.createWidget(this.el[t],t);return this.bindEvents(),this},createWidget:function(t,e){if(!t)return this;var i=this._getDataParams(t),a=this.iframeTemplate.replace("{host}",this.o.host).replace("{params}","?"+i.join("&")).replace("{style}",this.o.style).replace("{id}",e);t.innerHTML=a,t.setAttribute("data-widget-ready",1)},bindEvents:function(){t.addEventListener?t.addEventListener("message",this.onMessage.bind(this),!1):t.attachEvent&&t.attachEvent("onmessage",this.onMessage.bind(this))},onMessage:function(event){if(event.origin==this.o.protocol+this.o.host){var i="object"==typeof event.data?event.data:JSON.parse(event.data),a=Object.keys(i)[0];switch(a){case"delivery":"function"==typeof t[this.o.callbackName]&&t[this.o.callbackName](i[a])}}},onWidgetFrameLoad:function(t){console.log("Widget iframe loaded: ",t)},_getDataParams:function(t){for(var e=[],i=t.attributes,a=0,n=i.length;n>a;a++){var s=i[a],o=s.name;o.indexOf("data-")>-1&&e.push(o.replace("data-","")+"="+s.value)}return e}},t.gwClient||(t.gwClient=new a)}(this,this.document);
$(function(){function e(){i=1,$(".yved:nth-child("+i+")").fadeIn(500).delay(3e3).fadeOut(500)}$("a").click(function(){$("#"+$(this).data("modal")).css("display","block")}),$(".phone_mask").inputmask("+7(999)999-99-99"),$(".nav__link").click(function(){$(".nav__link").removeClass("nav__link-active"),$(this).addClass("nav__link-active")}),$(".toggle-mnu").click(function(){$(".nav").toggleClass("visible-nav")}),$(".nav__link").click(function(){$(".nav").toggleClass("visible-nav")}),$(".rus__bright-item").not(":first").hide(),$(".rus__bright-tabs").click(function(){$(".rus__bright-tabs").removeClass("active").eq($(this).index()).addClass("active"),$(".rus__bright-item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".eng__bright-item").not(":first").hide(),$(".eng__bright-tabs").click(function(){$(".eng__bright-tabs").removeClass("active").eq($(this).index()).addClass("active"),$(".eng__bright-item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".rus__dark-item").not(":first").hide(),$(".rus__dark-tabs").click(function(){$(".rus__dark-tabs").removeClass("active").eq($(this).index()).addClass("active"),$(".rus__dark-item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".eng__dark-item").not(":first").hide(),$(".eng__dark-tabs").click(function(){$(".eng__dark-tabs").removeClass("active").eq($(this).index()).addClass("active"),$(".eng__dark-item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".catalog__content-rus").not(":first").hide(),$(".rus__tab-item").click(function(){$(".rus__tab-item").removeClass("active").eq($(this).index()).addClass("active"),$(".catalog__content-rus").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".catalog__content-eng").not(":first").hide(),$(".eng__tab-item").click(function(){$(".eng__tab-item").removeClass("active").eq($(this).index()).addClass("active"),$(".catalog__content-eng").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".main_puzzle").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".russian-bright_puzzle").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".english-bright_puzzle").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".russian-dark_puzzle").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".english__dark_puzzle").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".certificates__link").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),jQuery("a.scrollto").click(function(){return elementClick=jQuery(this).attr("href"),destination=jQuery(elementClick).offset().top,jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:destination},1100),!1}),Modernizr.svg||$("img[src*='svg']").attr("src",function(){return $(this).attr("src").replace(".svg",".png")}),$("form").submit(function(){var e=$(this);return $.ajax({type:"GET",url:"mail.php",data:e.serialize()}).done(function(){window.location.href="spasibo.html",setTimeout(function(){e.trigger("reset")},1e3)}),!1}),$("a.btn").click(function(){var e=$(this).data("form"),i=$(this).data("text"),a=$(this).attr("data-img");$(".form__span").text(i),$(".form__img img").attr("src",a),$("#form__question [name=admin-data]").val(e)}),$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(".menu").slideToggle(),!1}),$(".btn__yes").click(function(){$(this).addClass("active"),$(".number__cart-dis").hide(),$(".number__cart").fadeIn(500),$(".price").hide(),$(".price__red").show(),$(".btn__no").removeClass("active")}),$(".btn__no").click(function(){$(this).addClass("active"),$(".number__cart-dis").show(),$(".number__cart").hide(),$(".price").show(),$(".price__red").hide(),$(".btn__yes").removeClass("active")});var i=0;setTimeout(function(){setInterval(function(){i+=1,i>10&&(i=1),$(".yved:nth-child("+i+")").fadeIn(500).delay(3e3).fadeOut(500)},4e4),e()},1e4)});