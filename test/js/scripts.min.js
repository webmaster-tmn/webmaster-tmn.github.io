...
$(function(){jQuery(function(i){i(window).scroll(function(){i(this).scrollTop()>5?i(".header_top").addClass("fixed"):i(this).scrollTop()<10&&i(".header_top").removeClass("fixed")})}),$(".slider__item").slick({autoplay:!0,arrows:!1}),$("form").submit(function(){var i=$(this);return $.ajax({type:"GET",url:"mail.php",data:i.serialize()}).done(function(){window.location.href="spasibo.html",setTimeout(function(){i.trigger("reset")},1e3)}),!1})});