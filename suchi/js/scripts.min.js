...
$(function(){$(".mainSlider").slick({arrows:!1,dots:!0,dotsClass:"slider__dots",autoplay:!0,autoplaySpeed:1e3}),$(".popup-modal").magnificPopup({type:"inline",removalDelay:700,midClick:!0,callbacks:{open:function(){e.slick("refresh")}}});var e=$(".bislunch").slick({arrows:!0,slidesToShow:1,slidesToScroll:1,nextArrow:".left__slide.carousel-control",prevArrow:".right__slide.carousel-control"});$(".phone_mask").inputmask("+7(999)999-99-99"),$("form#form__question").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail1.php",data:e.serialize()}).done(function(){$(".suc_question").show(),setTimeout(function(){$(".suc_question").hide(),e.trigger("reset"),$(".remodal-close").click()},3e3)}),!1}),$("a.scrollto").click(function(){return elementClick=$(this).attr("href"),destination=$(elementClick).offset().top,$("html:not(:animated),body:not(:animated)").animate({scrollTop:destination},1100),!1})});