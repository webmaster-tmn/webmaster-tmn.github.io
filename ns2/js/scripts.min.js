...
$(function(){if($("a").click(function(){$("#"+$(this).data("modal")).css("display","block")}),jQuery("a.scrollto").click(function(){return elementClick=jQuery(this).attr("href"),destination=jQuery(elementClick).offset().top,jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:destination},1100),!1}),$(".reviews__slider").slick({arrows:!1,dots:!1}),$(".r-slider_next").click(function(){$(".reviews__slider").slick("slickPrev")}),$(".r-slider_prev").click(function(){$(".reviews__slider").slick("slickNext")}),$(".photo__slider-top").slick({fade:!0,slidesToShow:1,slidesToScroll:1,arrows:!1,asNavFor:".photo__slider-bottom"}),$(".photo__slider-bottom").slick({slidesToShow:8,slidesToScroll:3,dots:!1,asNavFor:".photo__slider-top",focusOnSelect:!0,centerMode:!0,arrows:!0}),$(".photo-slider_next").click(function(){$(".photo__slider-bottom").slick("slickPrev")}),$(".photo-slider_prev").click(function(){$(".photo__slider-bottom").slick("slickNext")}),$("#gmap").length){var o;o=new GMaps({el:"#gmap",lat:43.565396,lng:39.756956,scrollwheel:!1,zoom:17,zoomControl:!1}),o.addMarker({lat:43.565257,lng:39.759756,animation:google.maps.Animation.DROP,verticalAlign:"bottom",horizontalAlign:"center",backgroundColor:"#3e8bff"})}});