...
$(function(){$("a").click(function(){$("#"+$(this).data("modal")).css("display","block")}),window.sr=ScrollReveal({reset:!0}),sr.reveal(".overlay",{duration:900,viewOffset:{top:250}}),sr.reveal(".overlay-1",{viewOffset:{top:250,bottom:250}}),$("form").submit(function(){var e=$(this);return $.ajax({type:"GET",url:"mail.php",data:e.serialize()}).done(function(){$(".remodal .success").addClass("active"),setTimeout(function(){$(".remodal .success").removeClass("active"),e.trigger("reset"),$(".remodal-close").click()},3e3)}),!1})});