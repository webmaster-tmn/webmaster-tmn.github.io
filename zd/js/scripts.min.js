...
$(function(){$("a").click(function(){$("#"+$(this).data("modal")).css("display","block")}),window.sr=ScrollReveal({reset:!0}),sr.reveal(".overlay",{duration:900,viewOffset:{top:250}}),sr.reveal(".overlay-1",{viewOffset:{top:250,bottom:250}})});